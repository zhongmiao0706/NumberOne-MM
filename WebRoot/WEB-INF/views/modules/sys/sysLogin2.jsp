...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://shop450532966.taobao.com" target="_blank">NumberOne专业开发</a> ${fns:getConfig('version')}
	</div>
